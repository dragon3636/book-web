    ...
    return (
        <div className='p-3 flex-col gap-2 max-w-[320px] '>
            <div className='flex justify-between'>
                <input type="text direc" name="work" id="" className='border border-slate-300' onChange={e => {
                    setJob(e.target.value);
                }} />
                <button type="button" className=' px-3 py-1 inline-block bg-blue-200 border border-slate-400 rounded font-bold text-white' onClick={() => handleAddWork(job)}>Add Work</button>
            </div>
