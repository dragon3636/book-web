...
import Comment from './components/f8/Comment';
...
function App() {
  ...
  return (
    <div className='w-full h-96'>
      <button type="button" className='bg-orange-500 rounded font-bold text-white p-3' onClick={() => setToggle(!toggle)}>Toggle</button>
